...
import { LayoutDashboard, BarChart2, FileText, LogOut, Tag ,GalleryHorizontalEnd } from "lucide-react";
...
export function AdminSidebar({ children, userRole, username }: AdminSidebarProps) {
  ...
  const allLinks = [
    ...
    },
    {
      ...
      label: "Banner",
      href: "/admin/banner",
      icon: <GalleryHorizontalEnd  className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />,
      roles: ['ADMIN', 'EMPLOYEE'], 
    },
    {
      label: "Categories",
